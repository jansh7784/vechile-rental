// Enhanced mock data for Car2go car rental matching thecomfortjourney.com
...
export const vehicles = [
  {
    ...
    available: true,
    selfDrive: true,
    description: "Perfect for off-road adventures and city drives"
  },
  {
    id: 2,
    name: "XUV 700",
  ...
  },
  {
    ...
    available: true,
    selfDrive: true,
    description: "Rugged SUV perfect for family trips and long journeys"
  },
  {
    id: 4,
    name: "Scorpio S11",
    ...
    available: true,
    selfDrive: true,
    description: "Reliable and comfortable SUV for all terrains"
  },
  {
    id: 5,
  ...
  },
  {
    ...
    available: true,
    selfDrive: true,
    description: "Premium SUV with luxury interiors and powerful performance"
  },
  {
    id: 7,
    name: "Dzire new",
    image: "/assets/Dzire new.jpeg",
    transmission: "Manual",
    fuelType: "CNG + Petrol",
    ...
    available: true,
    selfDrive: true,
    description: "Fuel-efficient sedan perfect for city drives"
  },
  {
    id: 8,
    name: "Swift Epic new",
...
// Blog data from thecomfortjourney.com
export const blogs = [
  {
    id: 1,
...
export const faqData = [
  ...
  },
  {
    ...
    answer: "Cancellation made between 24 hrs before booking start time - Flat cancellation fee of 100% of the Lease Rental paid in advance. Refund of the remaining portion of Lease Rental after deduction of Platform Fee. Cancellation made after booking start time - No refund of Lease Rental paid in advance. Notwithstanding anything contrary stated herein, Car2go reserves the right to withhold any refunds due to cancellations, if Car2go, at its sole discretion, perceives any credit card frauds by a user or where cancellations are made by a user with an intention to defraud Car2go."
  },
  {
    id: 13,
    question: "Extension Policy",
    answer: "In case a Guest wishes to extend the booking period, he/she may do so at any time before or after the booking ends. Extension of booking shall be applicable at normal tariff. Shortening post start: Not allowed. However, Guests can drop the vehicle before booking end time. No charges or refunds applicable."
  },
  {
    id: 14,
    question: "Late Return",
    answer: "Late return would be charged. Time (duration of rate): The calculation of the tariff rate is standard I.e 9am to 9am."
  },
  {
    id: 15,
    question: "Minimum Duration",
    answer: "The minimum booking duration (also referred to as the 'minimum billing duration') for which a booking can be made by the Guest will be at least for 48 hours. No booking under such duration will be entertained by Car2go on its Platform."
  },
  {
    id: 16,
    question: "Traffic and Parking violations",
    answer: "Full payment of fines to be claimed by the guest. No Show: Bookings would stand cancelled if after 4 hours of booking start time the Guest still doesn't show up. No refunds would be applicable."
  },
  {
    id: 17,
    question: "Home / Airport Vehicle Pick-up and Drop",
    answer: "Home delivery or airport delivery will be available at an additional fee plus the distance fee subject to availability and ongoing offers. The vehicle will be delivered to the specified location selected during booking creation, 0-5 minutes prior to the booking start time and vehicle will be picked up within 30 minutes from the booking end time. The Guest may end the trip before completion of the booking end time. The Guest shall not be charged if he/she has ended the trip before the booking end time and the car is yet to be picked up by the delivery executive of Car2go"
  }
];

// Expanded testimonials data for auto-scrolling homepage section
export const expandedTestimonials = [
  {
    id: 1,
    name: "Rahul Sharma",
    rating: 5,
  ...
  },
  {
    ...
    name: "Priya Singh",
    rating: 5,
    comment: "Amazing experience with Car2go! The cars are well-maintained and the staff is very professional.",
    date: "Nov 2024"
  },
  {
    id: 3,
    name: "Amit Patel",
    rating: 5,
    comment: "Booked a Thar for our Goa trip. Excellent condition and great service throughout our journey.",
    date: "Oct 2024"
  },
  {
    id: 4,
    name: "Neha Gupta",
    rating: 5,
    comment: "Very reliable service. Door-to-door delivery makes it so convenient. Highly recommended!",
    date: "Sep 2024"
  },
  {
    id: 5,
    name: "Vikram Joshi",
    rating: 5,
    comment: "Transparent pricing and no hidden charges. The XUV 700 we rented was in perfect condition.",
    date: "Aug 2024"
  },
  {
    id: 6,
    name: "Anita Reddy",
    rating: 5,
    comment: "Car2go made our family vacation memorable. Clean cars and prompt service.",
    date: "Jul 2024"
  },
  {
    id: 7,
    name: "Ravi Kumar",
    rating: 5,
    comment: "24/7 support is fantastic. They helped us during our late-night journey. Truly reliable!",
    date: "Jun 2024"
  },
  {
    id: 8,
    name: "Sunita Agarwal",
    rating: 5,
    comment: "The Fortuner we booked exceeded our expectations. Clean, comfortable, and fuel efficient.",
    date: "May 2024"
  }
];

// Compact testimonials for About page (3 items, no images)
export const aboutPageTestimonials = [
  {
    id: 1,
    name: "Rajesh Verma",
    rating: 5,
    comment: "Car2go has transformed how I travel. Professional service and excellent vehicle condition every time."
  },
  {
    id: 2,
    name: "Meera Jain",
    rating: 5,
    comment: "Reliable, affordable, and customer-friendly. Car2go is my first choice for car rentals in Indore."
  },
  {
    id: 3,
    name: "Suresh Agrawal",
    rating: 5,
    comment: "Outstanding service quality and well-maintained fleet. Highly recommend Car2go for all travel needs."
  }
];