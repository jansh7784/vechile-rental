        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              ...
              Experience the joy of driving with our well-maintained fleet of vehicles.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'About Us', 'Services', 'Fleet', 'Pricing', 'Contact'].map((link) => (
                <li key={link}>
                  <a
                    href="#"
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">info@thecomfortjourney.com</p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <div>
              ...
              <p className="text-gray-300 text-sm">
                Subscribe to get special offers, updates, and news.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © {currentYear} The Comfort Journey. All rights reserved.
            </p>
